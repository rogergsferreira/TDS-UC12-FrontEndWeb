...
Game.Load.prototype = {
  preload: function() {
    // bg image
    game.stage.backgroundColor = '#B30004';
    ...
    game.load.image('player', 'images/playerWhite.png');
    game.load.image('fire', 'images/fireWhite.png');
    game.load.image('bonus', 'images/bonus.png');
    game.load.image('pixel', 'images/pixelBlack.png');
    game.load.spritesheet('bullet', 'images/bulletBlack.png', 16, 32);
    game.load.image('enemy', 'images/enemyBlack.png');
